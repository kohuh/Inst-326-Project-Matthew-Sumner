...
After installing the required package, to use this program, just run the CFF.py file and input the values for departure, arrival, and outbound date. The program will then return the 10 cheapest flights matching your criteria.

Unit tests are included to verify all core logic. Run them with:
python -m pytest test_CFF.py -v
For details on what is tested and the written testing procedure for methods that cannot be unit tested (such as the live API call), see the comments in test_CFF.py.
